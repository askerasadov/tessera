...
| Layer 3 — Country code recognition (`MrzUnknownCountryCode`) | Deferred (depends on `CountryCode` value class + `CountryCodeTable`); will surface as a warning per [ADR-013](../decisions/0013-recognition-failures-are-warnings.md) |
