...
- **JDK 21.** The project compiles to JDK 21 (`jvmToolchain(21)` in every module's `build.gradle.kts`) and CI runs on JDK 21. [Adoptium Temurin](https://adoptium.net/) is a safe default on any platform.
